...
local function get_fg(normal_fg, bright_fg) return config.options.transparent_background and bright_fg or normal_fg end
...
hubbamax.insert = {
  a = {
    fg = get_fg(palette.base.bg.gui, palette.accent.green.gui),
    bg = get_bg(palette.accent.green.gui),
    gui = 'bold',
  },
  b = { fg = get_fg(palette.base.gray8.gui, palette.base.fg.gui), bg = get_bg(palette.base.gray3.gui) },
  c = { fg = get_fg(palette.base.gray6.gui, palette.base.gray7.gui), bg = get_bg(palette.base.gray2.gui) },
...
hubbamax.visual = {
  a = {
    fg = get_fg(palette.base.bg.gui, palette.accent.purple.gui),
    bg = get_bg(palette.accent.purple.gui),
    gui = 'bold',
  },
  b = { fg = get_fg(palette.base.gray8.gui, palette.base.fg.gui), bg = get_bg(palette.base.gray3.gui) },
  c = { fg = get_fg(palette.base.gray6.gui, palette.base.gray7.gui), bg = get_bg(palette.base.gray2.gui) },
...
hubbamax.command = {
  a = {
    fg = get_fg(palette.base.bg.gui, palette.accent.yellow_bright.gui),
    bg = get_bg(palette.accent.yellow_bright.gui),
    gui = 'bold',
  },
  b = { fg = get_fg(palette.base.gray8.gui, palette.base.fg.gui), bg = get_bg(palette.base.gray3.gui) },
  c = { fg = get_fg(palette.base.gray6.gui, palette.base.gray7.gui), bg = get_bg(palette.base.gray2.gui) },
