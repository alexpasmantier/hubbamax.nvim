...
M.diff = {
  add = { gui = '#2a3a2a', cterm = M.accent.green.cterm },
  change = { gui = '#3b3624', cterm = M.accent.yellow.cterm },
  text = { gui = '#4a4026', cterm = M.accent.yellow.cterm },
  delete = { gui = '#3b2a2a', cterm = M.accent.red.cterm },
}
